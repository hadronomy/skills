...
Call `handoff_transfer` once with the complete intent. Report the pointer on success: fork-local names the next session to resume; export-file names the file to move before import.
